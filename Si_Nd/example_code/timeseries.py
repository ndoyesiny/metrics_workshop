...
Author: Youssouph Sane, Leeds at December 2016 modify by Siny
'''
import numpy as np
...
def main():
     ...
     h11 = iris.load_cube(iris.sample_data_path('/media/AMMA2050_AFRICSN/CMIP5_AFRICA/BC_0.5x0.5/IPSL-CM5A-LR/historical/tasmax_WFDEI_1979-2013_0.5x0.5_day_IPSL-CM5A-LR_africa_historical_r1i1p1_full.nc'))
     #h11 = iris.load_cube('/media/AMMA2050_WA_SINY/WA_data/BC_0.5x0.5/IPSL-CM5A-LR/historical/tasmax_WFDEI_1979-2013_0.5x0.5_day_IPSL-CM5A-LR_africa_historical_r1i1p1_full.nc')
     ee85 = iris.load_cube(iris.sample_data_path('/media/AMMA2050_AFRICSN/CMIP5_AFRICA/BC_0.5x0.5/IPSL-CM5A-LR/rcp85/tasmax_WFDEI_1979-2013_0.5x0.5_day_IPSL-CM5A-LR_africa_rcp85_r1i1p1_full.nc'))
